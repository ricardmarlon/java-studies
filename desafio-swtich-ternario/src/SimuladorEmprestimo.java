/*Uma financeira contratou um programador para desenvolver um programa que calcula  custo total de empréstimos para seus
clientes, porém o contrato foi cancelado e você foi chamado para concluir a programação do sistema.
...
public class SimuladorEmprestimo {
    ...
    public static void main(String[] args) {
        ...
        //used the new switch expression updated in Java 17
